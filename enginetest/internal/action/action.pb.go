...
func file_github_com_dogmatiq_enginekit_enginetest_internal_action_action_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_dogmatiq_enginekit_enginetest_internal_action_action_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Action); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_dogmatiq_enginekit_enginetest_internal_action_action_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_dogmatiq_enginekit_enginetest_internal_action_action_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:

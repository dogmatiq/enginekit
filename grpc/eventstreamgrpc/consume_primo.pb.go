...
// calling proto.Marshal(x).
//
// It allows [*EventType] to implement [encoding.BinaryMarshaler].
func (x *EventType) MarshalBinary() ([]byte, error) {
	return proto.Marshal(x)
}
...
// calling proto.Unmarshal(data, x).
//
// It allows [*EventType] to implement [encoding.BinaryUnmarshaler].
func (x *EventType) UnmarshalBinary(data []byte) error {
	return proto.Unmarshal(data, x)
}
...
// calling proto.Marshal(x).
//
// It allows [*NoRecognizedMediaTypes] to implement [encoding.BinaryMarshaler].
func (x *NoRecognizedMediaTypes) MarshalBinary() ([]byte, error) {
	return proto.Marshal(x)
}
...
// calling proto.Unmarshal(data, x).
//
// It allows [*NoRecognizedMediaTypes] to implement [encoding.BinaryUnmarshaler].
func (x *NoRecognizedMediaTypes) UnmarshalBinary(data []byte) error {
	return proto.Unmarshal(data, x)
}

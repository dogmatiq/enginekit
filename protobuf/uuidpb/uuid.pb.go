...
var file_github_com_dogmatiq_enginekit_protobuf_uuidpb_uuid_proto_goTypes = []interface{}{
...
func file_github_com_dogmatiq_enginekit_protobuf_uuidpb_uuid_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_dogmatiq_enginekit_protobuf_uuidpb_uuid_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UUID); i {
			case 0:
				return &v.state
			case 1:

...
const file_github_com_dogmatiq_enginekit_protobuf_uuidpb_uuid_proto_rawDesc = "" +
	"\n" +
	"8github.com/dogmatiq/enginekit/protobuf/uuidpb/uuid.proto\x12\x0edogma.protobuf\"2\n" +
	"\x04UUID\x12\x14\n" +
	"\x05upper\x18\x01 \x01(\x04R\x05upper\x12\x14\n" +
	"\x05lower\x18\x02 \x01(\x04R\x05lowerB/Z-github.com/dogmatiq/enginekit/protobuf/uuidpbb\x06proto3"

var (
	file_github_com_dogmatiq_enginekit_protobuf_uuidpb_uuid_proto_rawDescOnce sync.Once
	file_github_com_dogmatiq_enginekit_protobuf_uuidpb_uuid_proto_rawDescData []byte
)
...
func file_github_com_dogmatiq_enginekit_protobuf_uuidpb_uuid_proto_rawDescGZIP() []byte {
	file_github_com_dogmatiq_enginekit_protobuf_uuidpb_uuid_proto_rawDescOnce.Do(func() {
		file_github_com_dogmatiq_enginekit_protobuf_uuidpb_uuid_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_dogmatiq_enginekit_protobuf_uuidpb_uuid_proto_rawDesc), len(file_github_com_dogmatiq_enginekit_protobuf_uuidpb_uuid_proto_rawDesc)))
	})
